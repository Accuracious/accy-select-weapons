SWEP.Category				= "Robotnik Battlefield 4"
SWEP.Author				= ""
SWEP.Contact				= ""
SWEP.Purpose				= ""
SWEP.Instructions				= ""
...
SWEP.PrintName				= "SRR-61 Ballistic"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/v_bf4_srr61bal.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_bf4_srr61bal.mdl"	-- Weapon world model
SWEP.Base				= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater = false

SWEP.Primary.Sound			= Sound("bf4_srr_bal.Single")		-- Script that calls the primary fire sound
...
SWEP.SightsPos = Vector(4.28, -6.04, -0.201)
SWEP.SightsAng = Vector(0.4, -0.5, 0)
SWEP.RunSightsPos = Vector (-1.241, 0, -2.481)
SWEP.RunSightsAng = Vector (-11, -44.6, 26.1)
SWEP.InspectPos = Vector(0, 0, 0)
SWEP.InspectAng = Vector(-15, -6.2, 0)
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/rtcircle.mdl", bone = "tag_weapon", rel = "", pos = Vector(0.082, 0.589, 5.65), angle = Angle(0, 0, 0), size = Vector(0.474, 0.474, 0.474), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
